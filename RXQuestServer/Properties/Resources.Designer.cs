...
namespace RFTechnology.Properties {
    ...
    internal class Resources {
        ...
        /// <summary>
        ///   查找类似 欢迎您使用锐锋科技提供的数字化产品，您的支持是我们前进的动力，欢迎您在使用过程中提供您宝贵的意见，我们将免费持续更新为您的工作保驾护航，提供更高效的工作通道。 欢迎加入该软件技术支持群:685526378  或者微信公共号：锐锋科技有限公司 如需发票请邮件[yecc10@live.cn]也可以公共号反馈【注意请截图订单号】。 注意：若注册过程出现任何疑问欢迎公共号或邮件咨询，若出现扣款成功软件注册未完成的也按上述进行处理！ 的本地化字符串。
        /// </summary>
